import { IMarkerData, MarkerSeverity } from '../types/monaco-types';
...
export function parseMergedOutputs(mergedOutputs: MergedOutputs, opts: MergedOutputsOptions): IMarkerData[] {
  let unmatchedLines = [];
